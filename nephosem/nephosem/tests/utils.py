...
"""Module contains common utilities used in automated code tests for QLVL modules.
...
def datapath(fname):
    ...
    Usually used to place corpus to data directory.
    ...
    -------
    str
        Full path to `fname` in data folder.
